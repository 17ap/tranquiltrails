...
export default function WhyJoinSection() {
    const reasons = [
      ...
      "Стань частью вдохновляющего женского комьюнити, где царит поддержка, доверие и открытость. Здесь ты найдешь подруг, которые помогут тебе расти и развиваться!"
    ];
