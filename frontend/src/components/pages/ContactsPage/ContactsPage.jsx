          ...
          <div className="contacts-container">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="checkbox-group">
                    ...
                    <label htmlFor="agreement">
                      Даю согласие на обработку персональных данных и ознакомлена с политикой конфиденциальности.
                    </label>
                  </div>
            ...
            <div className="contacts-info">
              <div className="info-item">
                <h3>Адрес</h3>
                <p>г. Санкт-Петербург, наб. Макарова 60к1, офис 427</p>
              </div>
              
              <div className="info-item">
                <h3>Телефон</h3>
                <p><a href="tel:78125253345">+7(812)525-33-45</a></p>
